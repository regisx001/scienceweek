<script lang="ts">
	...
	export let borderRadius: number = 999;
...
<div
	style="
      ...
      "
	class={cn(
		'relative grid min-h-[60px] w-fit  place-items-center rounded-full bg-white p-3 text-black dark:bg-black dark:text-white',
		className
	)}
>
	<div

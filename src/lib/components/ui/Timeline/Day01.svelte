<div class="rounded-lg border bg-background p-6 shadow-sm transition-all hover:shadow-md">
	...
	<div class="mb-6 flex items-center justify-between">
		<div>
			<h3 class="text-lg font-semibold text-foreground">Journée Informatique</h3>
	...
	<p class="mb-6 text-sm text-muted-foreground">
		Une journée immersive dédiée aux technologies informatiques avec conférences et ateliers
		pratiques.
	</p>
	...
	<div class="space-y-3">
		...
		>
			...
			<div class="mt-2 flex items-center gap-2 text-xs text-muted-foreground">
				...
				<span>Amphithéâtre Principal</span>
			</div>
		</div>
		...
		>
			<div class="flex items-start justify-between">
				...
				<span class="z-50 rounded-full bg-secondary/10 px-2 py-1 text-xs font-bold">
					12h-13h30
				</span>
			</div>
			<div class="mt-2 flex items-center gap-2 text-xs text-muted-foreground">
				...
				<span>Salle des Conférences B</span>
			</div>
		</div>
